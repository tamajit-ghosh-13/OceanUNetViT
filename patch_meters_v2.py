...
# 1. Cyclone (Swap to red->green->blue, and use clip-path)
target_1 = r"""                        <div className="w-full h-3 bg-gradient-to-r from-blue-500 via-yellow-500 to-rose-600 rounded-full overflow-hidden border border-glass-border relative">
                          <div 
...
new_1 = r"""                        <div className="w-full h-3 bg-surface-container rounded-full overflow-hidden border border-glass-border relative">
                          <div 
...
# 2. Heatwave (Keep orange->red, use clip-path)
target_2 = r"""                        <div className="w-full h-3 bg-gradient-to-r from-blue-400 via-orange-400 to-red-600 rounded-full overflow-hidden border border-glass-border relative">
                          <div 
                            className="absolute right-0 top-0 bottom-0 bg-surface-container"
...
new_2 = r"""                        <div className="w-full h-3 bg-surface-container rounded-full overflow-hidden border border-glass-border relative">
                          <div 
...
# 3. Drought (Swap to blue->yellow->rose, use clip-path)
target_3 = r"""                        <div className="w-full h-3 bg-gradient-to-r from-red-500 via-green-400 to-blue-600 rounded-full overflow-hidden border border-glass-border relative">
                          <div 
                            className="absolute right-0 top-0 bottom-0 bg-surface-container"
...
new_3 = r"""                        <div className="w-full h-3 bg-surface-container rounded-full overflow-hidden border border-glass-border relative">
                          <div 
...
# 4. Algae (Keep emerald->green, use clip-path)
target_4 = r"""                        <div className="w-full h-3 bg-gradient-to-r from-emerald-600 via-yellow-400 to-green-300 rounded-full overflow-hidden border border-glass-border relative">
                          <div 
                            className="absolute right-0 top-0 bottom-0 bg-surface-container"
...
new_4 = r"""                        <div className="w-full h-3 bg-surface-container rounded-full overflow-hidden border border-glass-border relative">
                          <div 
