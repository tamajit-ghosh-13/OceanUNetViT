...
def plot_tri_depth_snapshot_custom(preds_tri, targets_c, depth_idx, sample_idx=15, save_path=""):
    ...
    # UNIFIED COLORBAR for the first two subplots (GLORYS and Tri-Breed)
    fig.colorbar(im1, ax=axes[0:2], orientation="horizontal", pad=0.08, label=f"Temperature ({deg}C)")
